...
# This is the file that contains the beads for doing the image map (this shouldn't be z-projected):
beads_file=r'/Users/Mathew/Dropbox (Cambridge University)/Ed Code/ONI_Channel_Mapping/Images/Beads/Concentrationcurve_tweenexp_Channel ampping_posXY2_channels_t0_posZ0.tif'
...
# Paths to mapy
pathList.append(r"/Users/Mathew/Dropbox (Cambridge University)/Ed Code/ONI_Channel_Mapping/Images/Positive/")
pathList.append(r"/Users/Mathew/Dropbox (Cambridge University)/Ed Code/ONI_Channel_Mapping/Images/Blank/")
pathList.append(r"/Users/Mathew/Dropbox (Cambridge University)/Ed Code/ONI_Channel_Mapping/Images/Asyn/")
...
greenSlice = (img[49,0:684,0:428]/255).astype(np.uint8)
redSlice = (img[49,0:684,428:856]/255).astype(np.uint8)
...
for path in pathList:
    ...
    greenSlice2 = (img_to_convert[0:684,0:428]).astype('uint16')
    redSlice2 = (img_to_convert[0:684,428:856]).astype('uint16')
